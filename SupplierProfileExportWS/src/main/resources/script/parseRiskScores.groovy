...
<root>
  <realm>SandboxAtlantic-T</realm>
  <smVendorId>S17931936</smVendorId>
  <erpVendorId>USSU-CIG10</erpVendorId>
  <sourceSystem>SM</sourceSystem>
  <scoreId>304275255</scoreId>
  <scoreCalculationDate>2021-02-11</scoreCalculationDate>
  <overallScore>1</overallScore>
  <overallScoreLevel>2</overallScoreLevel>
  <riskCategoryScores>
    <riskCategoryName>environmentalAndSocial</riskCategoryName>
    <riskCategoryScore>1</riskCategoryScore>
    <riskCategoryScoreLevel>2</riskCategoryScoreLevel>
  </riskCategoryScores>
  <riskCategoryScores>
    <riskCategoryName>financial</riskCategoryName>
    <riskCategoryScore>0</riskCategoryScore>
    <riskCategoryScoreLevel>1</riskCategoryScoreLevel>
  </riskCategoryScores>
  <riskCategoryScores>
    <riskCategoryName>legalAndRegulatory</riskCategoryName>
    <riskCategoryScore>0</riskCategoryScore>
    <riskCategoryScoreLevel>1</riskCategoryScoreLevel>
  </riskCategoryScores>
  <riskCategoryScores>
    <riskCategoryName>operational</riskCategoryName>
    <riskCategoryScore>0</riskCategoryScore>
    <riskCategoryScoreLevel>1</riskCategoryScoreLevel>
  </riskCategoryScores>
  <responseTimeStamp>2021-03-29 12:17:17.000000893</responseTimeStamp>
  <scoreConfigurationVersion>18</scoreConfigurationVersion>
</root>
*/
        println("hello there");
        ...
        */    
        ...
        else if(orgId=="USSU-CIG15"){
            //Spot Buy Vendor DE
            keyStr.append("\"orgId\" :");
            keyStr.append("\"S17931942\"");            
        }         
        else{
